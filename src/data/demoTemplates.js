...
export const TEMPLATE_CUSTOMER_LOOKUP = {
  ...
  components: [
    ...
    { id: "cmp_3", compId: "tpl-a-003", type: "status-badge", parentId: "cmp_1", layout: { x: 30, y: 0, w: 8, h: 3 }, props: { fieldId: "sys_status", label: "Online", hAlign: "right", vAlign: "middle", hiddenCon: "", readonlyCon: "", events: { onPageLoad: [], onClick: [], onChange: [] }, tone: "success" } },
    ...
    { id: "cmp_16", compId: "tpl-a-016", type: "action-button", parentId: "cmp_10", layout: { x: 13, y: 12, w: 12, h: 3 }, props: { fieldId: "btn_reset", label: "Reset", hAlign: "left", vAlign: "top", hiddenCon: "", readonlyCon: "", events: { onPageLoad: [], onClick: [], onChange: [] }, actionType: "navigate", icon: "refresh", colorPreset: "secondary", params: "", customBgColor: "#3b82f6", customTextColor: "#ffffff" } },
    ...
    { id: "cmp_22", compId: "tpl-a-022", type: "status-badge", parentId: "cmp_20", layout: { x: 30, y: 0, w: 8, h: 3 }, props: { fieldId: "cust_badge", label: "Active", hAlign: "right", vAlign: "middle", hiddenCon: "", readonlyCon: "", events: { onPageLoad: [], onClick: [], onChange: [] }, tone: "success" } },
...
export const TEMPLATE_PRODUCT_SHOWCASE = {
  ...
  components: [
    ...
    { id: "cmp_3", compId: "tpl-c-003", type: "status-badge", parentId: "cmp_1", layout: { x: 30, y: 0, w: 8, h: 3 }, props: { fieldId: "live_badge", label: "Live", hAlign: "right", vAlign: "middle", hiddenCon: "", readonlyCon: "", events: { onPageLoad: [], onClick: [], onChange: [] }, tone: "success" } },
    ...
    { id: "cmp_14", compId: "tpl-c-014", type: "status-badge", parentId: "cmp_10", layout: { x: 26, y: 3, w: 12, h: 3 }, props: { fieldId: "feat_badge", label: "5G", hAlign: "left", vAlign: "middle", hiddenCon: "", readonlyCon: "", events: { onPageLoad: [], onClick: [], onChange: [] }, tone: "success" } },
